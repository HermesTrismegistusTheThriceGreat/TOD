# Alpaca API - Create an Order (POST)
...
### side
- **Type:** string (enum)
- **Required:** Yes (except for mleg order class)
...
- **Description:** In case of `mleg`, the limit_price parameter is expressed with the following notation:
...
### trail_price
- **Type:** string
- **Required:** This or `trail_percent` is required if type is `trailing_stop`

### trail_percent
- **Type:** string
- **Required:** This or `trail_price` is required if type is `trailing_stop`

### extended_hours
- **Type:** boolean
- **Default:** false
- **Description:** If true, order will be eligible to execute in premarket/afterhours. Only works with type limit and time_in_force day.
...
- **Max Items:** 4
- **Description:** List of order legs
...
- **Type:** object
- **Description:** Advanced instructions for Elite Smart Router
- **Reference:** [Alpaca Elite Smart Router Documentation](https://docs.alpaca.markets/docs/alpaca-elite-smart-router)
...
### 403 - Forbidden
- **Description:** Buying power or shares is not sufficient.

### 422 - Unprocessable
- **Description:** Input parameters are not recognized.
