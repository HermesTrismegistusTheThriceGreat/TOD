...
Learn more about the API products Alpaca offers at [https://alpaca.markets](https://alpaca.markets/).
...
You can find the documentation site here: [https://alpaca.markets/sdks/python/getting_started.html](https://alpaca.markets/sdks/python/getting_started.html)

You can also find the API Reference of Alpaca APIs: [https://docs.alpaca.markets/reference](https://docs.alpaca.markets/reference)
...
We're excited to support options trading! Use this section to read up on Alpaca's options trading capabilities. For more details, please refer to [our documentation page for options trading](https://docs.alpaca.markets/docs/options-trading)
...
- **Latest Release:** v0.43.2 (November 4, 2025)
- **Total Releases:** 84

## Topics

python, finance, options, crypto, trading, algotrading, brokerage, quant, market-data, quantitative-finance, algorithmic-trading, equities, alpaca, stock-trading, alpaca-api
...
See [CONTRIBUTING.md](https://github.com/alpacahq/alpaca-py/blob/master/CONTRIBUTING.md)
